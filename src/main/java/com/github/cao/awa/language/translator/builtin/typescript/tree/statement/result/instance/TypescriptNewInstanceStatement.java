package com.github.cao.awa.language.translator.builtin.typescript.tree.statement.result.instance;
...
public class TypescriptNewInstanceStatement extends TypescriptResultStatement {
    ...
    public TypescriptNewInstanceStatement(LanguageAst parent) {
        super(parent);
    }
